...
$activeNav = 'profile';
$user = $user ?? [];
$profile_action = url('accountant/profile');
$email_action = url('accountant/profile/email');
$email_otp_action = url('accountant/profile/email/verify-otp');
...
<div class="card content-card">
    <div class="toolbar">
        ...
        <a href="<?php echo e(url('accountant/dashboard')); ?>" class="btn btn-ghost">Back to Dashboard</a>
    </div>
