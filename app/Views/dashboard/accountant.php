<?php
$redirectUrl = url('accountant/dashboard');
?>
<?php ob_start(); ?>
<div class="card content-card" style="text-align: center;">
	<h2 style="margin-top: 0;">Accountant Dashboard</h2>
	<p style="color: #64748b;">Redirecting you to the updated accountant dashboard.</p>
	<script>
