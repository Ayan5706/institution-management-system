...
<div class="card content-card">
    <div class="toolbar">
        <div>
            ...
            <div style="color:#64748b;">Review and approve email change requests</div>
        </div>
        <div>
...
<script>
    ...
    function loadEmailRequests() {
        fetch('<?php echo e(url('api/principal/email-requests')); ?>', {
    ...
    function approveRequest(requestId) {
        fetch(`<?php echo e(url('principal/email-requests')); ?>/${requestId}/approve`, {
            method: 'POST',
            headers: {
    ...
    function rejectRequest(requestId) {
        fetch(`<?php echo e(url('principal/email-requests')); ?>/${requestId}/reject`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'X-Requested-With': 'XMLHttpRequest'
