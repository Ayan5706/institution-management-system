...
$activeNav = 'profile';
$user = $user ?? [];
$profile_action = url('vp/profile');
$email_action = url('vp/profile/email');
$email_otp_action = url('vp/profile/email/verify-otp');
...
<div class="card content-card">
    <div class="toolbar">
        ...
        <a href="<?php echo e(url('vp/dashboard')); ?>" class="btn btn-ghost">Back to Dashboard</a>
    </div>
